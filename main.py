...
def init_db():
    ...
    if cur.fetchone()[0] == 0:
        protocols = [
            ...
            ("Эндокардит","community","Ампициллин+Гентамицин","Ампициллин 2 г 4 р/сут + Гентамицин 1 мг/кг 3 р/сут","4-6 недель","Ванкомицин+Гентамицин","Ванкомицин 15 мг/кг + Гентамицин","4-6 недель","Цефтриаксон","2 г в/в 1 р/сут","4-6 недель","Даптомицин","6-8 мг/кг 1 р/сут","4-6 недель","Коррекция гентамицина по CrCl","по инструкции","4-6 недель","Инфекционный эндокардит нативных клапанов"),
            ("Эндокардит","late_mrsa","Ванкомицин+Гентамицин","Ванкомицин 15 мг/кг + Гентамицин 1 мг/кг 3 р/сут","6 недель","Даптомицин+Гентамицин","Даптомицин 8 мг/кг + Гентамицин","6 недель","Линезолид","600 мг в/в 2 р/сут","6 недель","Ампициллин+Ванкомицин","Ампициллин 2 г + Ванкомицин","6 недель","Коррекция всех","по CrCl","6 недель","Эндокардит протезированных клапанов"),
